          ...
          {submitStatus === 'success' ? (
            <div className="bg-white border border-brandYellow/40 p-12 text-center rounded-sm shadow-sm">
              ...
              <button
                ...
                className="mt-6 text-[10px] tracking-[0.15em] uppercase text-brand-blue hover:text-brand-blue-light border-b border-brand-blue pb-0.5 font-bold transition-colors"
              >
            ...
            >
              ...
              <div className="pt-2">
                <button
                  ...
                  type="submit"
                  disabled={submitting}
                  className="w-full md:w-auto px-12 py-4 bg-brand-blue hover:bg-brand-blue-light text-cream-50 font-bold text-xs tracking-[0.15em] uppercase transition-all shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-blue disabled:opacity-50 disabled:cursor-not-allowed rounded-sm"
                >
